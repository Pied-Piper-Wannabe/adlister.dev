    ...
    <section id="login">
        <div class="row">
            <div class="col-sm offset-sm-0 col-md-6 offset-md-3">
                <div class="whiteBox">
                    <h1 class="section-title centerText">Signup For Pie Piper</h1>
                    <p class="centerText" id="form-description">Please fill out the information below so we can create your account.</p>
