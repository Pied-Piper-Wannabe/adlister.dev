...
<div class="container">
    ...
    <div class="row">
        <div class="col centerText">
            <?PHP if ($page > 1) : ?>
                <a class="btn btn-outline-success" href="/account?page=<?= $page - 1 ?>" role="button">Previous</a>
            <?PHP else : ?>
                <a class="btn btn-outline-success disabled" href="/account?page=<?= $page - 1 ?>" role="button">Previous</a>
            <?PHP endif; ?>

            <?PHP if ($page < $pages) : ?>
                <a class="btn btn-outline-success" href="/account?page=<?= $page + 1 ?>" role="button">Next</a>
            <?PHP else : ?>
                <a class="btn btn-outline-success disabled" href="/account?page=<?= $page + 1 ?>" role="button">Next</a>
            <?PHP endif; ?>
