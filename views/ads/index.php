    ...
    <div class="row">
        <?PHP foreach ($results as $result) : ?>
            <div class="card" style="width: 20rem;">
                <a href="http://adlister.dev/show?id=<?= $result['id']?>&cat=<?=$result['category']?>"><img class="card-img-top" src="../img/uploads/<?= $result['photodir']?>" alt="Card image cap" style="width: 100%"></a>
